# Contributing guidelines for the EMG-style-transfer project

Are you interested in contributing for the development of the EMG-style-transfer project? 
...
Contributions should be first be opened as [issues](https://github.com/larocs/EMG-style-transfer/issues). 
So, before openning a pull request with contribution, please be sure there is an open issue demanding it.
